...
#
# $Id: mapdatocontaminanteaforolist.py 189 2010-04-09 09:21:47Z bruno $
# $URL: https://www.litec.csic.es/svn/emisiones/trunk/src/calenton/forms/mapdatocontaminanteaforolist.py $
#
##############################################################################
...
from .ui.Ui_mapdatocontaminanteaforolist import *
from .mapdatocontaminanteaforodlg import MapDatoContaminanteAforoDlg
from ..widgets.datalist import DataList
from ts import FKItemDelegate

class MapDatoContaminanteAforoList (DataList, Ui_MapDatoContaminanteAforoListClass):
	def __init__(self, parent = None):
		...
		if app.databaseInit:
			...
			self.cambiaEncabezado(self.model, ['Dato', 'Clasificación','Aforo', 'Contaminante','Factor'])
	...
	def on_anade_clicked(self, checked):
		d = MapDatoContaminanteAforoDlg(self, self.model)
		if d.add():
	...
	def on_tabla_doubleClicked(self, index):
		dm = MapDatoContaminanteAforoDlg(self, self.model)
