...
# Form implementation generated from reading ui file 'tabledlg.ui'
#
...
class Ui_TableDlgClass(object):
    def setupUi(self, TableDlgClass):
        TableDlgClass.setObjectName(_fromUtf8("TableDlgClass"))
        TableDlgClass.resize(492, 570)
        self.verticalLayout_3 = QtGui.QVBoxLayout(TableDlgClass)
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.tabs = QtGui.QTabWidget(TableDlgClass)
        ...
        self.buttonBox = QtGui.QDialogButtonBox(TableDlgClass)
        ...
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("accepted()")), TableDlgClass.accept)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("rejected()")), TableDlgClass.reject)
        QtCore.QMetaObject.connectSlotsByName(TableDlgClass)
        TableDlgClass.setTabOrder(self.tabs, self.nombre)
        TableDlgClass.setTabOrder(self.nombre, self.descripcion)
        TableDlgClass.setTabOrder(self.descripcion, self.sql)
        TableDlgClass.setTabOrder(self.sql, self.titulo)
        TableDlgClass.setTabOrder(self.titulo, self.nombreX)
        TableDlgClass.setTabOrder(self.nombreX, self.nombreY)
        TableDlgClass.setTabOrder(self.nombreY, self.barras)
        TableDlgClass.setTabOrder(self.barras, self.barrasAc)
        TableDlgClass.setTabOrder(self.barrasAc, self.tarta)
        TableDlgClass.setTabOrder(self.tarta, self.lineas)
        TableDlgClass.setTabOrder(self.lineas, self.buttonBox)

    def retranslateUi(self, TableDlgClass):
        TableDlgClass.setWindowTitle(_translate("TableDlgClass", "Datos de la Tabla", None))
        self.label_3.setText(_translate("TableDlgClass", "Nombre", None))
        self.label.setText(_translate("TableDlgClass", "Descripción", None))
        self.label_2.setText(_translate("TableDlgClass", "SQL", None))
        self.tabs.setTabText(self.tabs.indexOf(self.general), _translate("TableDlgClass", "General", None))
        self.label_4.setText(_translate("TableDlgClass", "Título", None))
        self.label_5.setText(_translate("TableDlgClass", "Nombre eje X", None))
        self.label_6.setText(_translate("TableDlgClass", "Nombre eje Y", None))
        self.groupBox.setTitle(_translate("TableDlgClass", "Tipo de Tabla", None))
        self.barras.setText(_translate("TableDlgClass", "Barras", None))
        self.barrasAc.setText(_translate("TableDlgClass", "Barras acumulativo", None))
        self.tarta.setText(_translate("TableDlgClass", "Tarta", None))
        self.lineas.setText(_translate("TableDlgClass", "Líneas", None))
        self.tabs.setTabText(self.tabs.indexOf(self.parametros), _translate("TableDlgClass", "Parámetros", None))
...
if __name__ == "__main__":
    ...
    TableDlgClass = QtGui.DataDialog()
    ui = Ui_TableDlgClass()
    ui.setupUi(TableDlgClass)
    TableDlgClass.show()
    sys.exit(app.exec_())
