...
> **Nota:** Los ficheros `.so` compilados y los Makefiles generados por qmake no se incluyen en el repositorio — contienen rutas absolutas específicas de cada máquina. Cada usuario debe ejecutar `qmake` antes de `make`.
